...
set(ROCGALGAME_COCOS_BUILD_DIR "${CURRENT_BUILDTREES_DIR}/${TARGET_TRIPLET}-rel")
set(ROCGALGAME_REUSE_COCOS_BUILD OFF)
if(EXISTS "${ROCGALGAME_COCOS_BUILD_DIR}/build.ninja"
   AND EXISTS "${ROCGALGAME_COCOS_BUILD_DIR}/CMakeCache.txt")
    file(STRINGS "${ROCGALGAME_COCOS_BUILD_DIR}/CMakeCache.txt"
         ROCGALGAME_COCOS_CACHE_HOME
         REGEX "^CMAKE_HOME_DIRECTORY:INTERNAL=")
    if(ROCGALGAME_COCOS_CACHE_HOME STREQUAL "CMAKE_HOME_DIRECTORY:INTERNAL=${SOURCE_PATH}")
        set(ROCGALGAME_REUSE_COCOS_BUILD ON)
    else()
        message(STATUS "Discarding stale Cocos2d-x buildtree")
        file(REMOVE_RECURSE "${ROCGALGAME_COCOS_BUILD_DIR}")
    endif()
endif()

if(ROCGALGAME_REUSE_COCOS_BUILD)
