...
function(vcpkg_configure_meson)
    ...
    # The compiler already receives --sysroot. Letting pkg-config apply the
    # same sysroot prefixes absolute vcpkg paths with it a second time.
    set(_gkd_pkgconfig_env_vars PKG_CONFIG_SYSROOT_DIR)
    if(TARGET_TRIPLET MATCHES "^x64-" OR VCPKG_TARGET_TRIPLET MATCHES "^x64-")
        list(APPEND _gkd_pkgconfig_env_vars PKG_CONFIG_LIBDIR)
    endif()
    vcpkg_backup_env_variables(VARS ${_gkd_pkgconfig_env_vars})
    ...
    vcpkg_restore_env_variables(VARS ${_gkd_pkgconfig_env_vars})
endfunction()
